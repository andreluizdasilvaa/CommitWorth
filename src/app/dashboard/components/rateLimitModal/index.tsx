...
export function RateLimitModal({
    ...
    return (
        <div style={visible ? { display: 'flex'} : { display: 'none'} } className="fixed bottom-12 left-4 flex flex-col text-sm/5 bg-primarymediumblue/20 text-primarybege p-2 w-fit rounded shadow-xl">
